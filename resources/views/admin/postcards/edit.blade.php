                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 lg:col-span-2">
                            ...
                            <div class="flex flex-wrap gap-6">
                                ...
                                <label for="condition" class="flex items-center gap-2 text-sm text-white/70">
                ...
                <section class="rounded-xl border border-white/10 bg-black/20 p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input id="purchase_date" type="date" name="purchase_date" value="{{ old('purchase_date', $postcard->purchase_date?->format('Y-m-d') ?? '') }}"
