...
<x-layout title="Newspapers — CollectorWWII" :mainClass="'w-full px-0 py-0'">
    <div class="w-full">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-4 items-center">
                        <div class="flex items-center justify-between">
                            <nav class="flex items-center pl-1 space-x-2 font-mono text-[11px] tracking-[0.15em] text-white/60 uppercase">
                                ...
                                <h1 class="inline text-khaki/70 font-mono text-[11px] tracking-[0.1em] uppercase">Newspapers</h1>
                            </nav>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 h-full">
                    ...
                    <a href="{{ route('newspapers.show', $newspaper) }}" target="_blank"
                        ...
                        <div class="flex-1 flex justify-center items-center h-80">
                            <img src="{{ $newspaper->thumbnail_url ?? asset('images/error-image-not-found.png') }}"
                                alt="{{ $newspaper->title }}"
